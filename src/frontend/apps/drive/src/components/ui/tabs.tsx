// Primitive shadcn — Tabs (Radix). Pages Router : pas de "use client".
// L'orientation et la navigation clavier suivent la direction (RTL) héritée du
// DirectionProvider (cf. DsProvider).
