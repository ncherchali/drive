// Sidebar shadcn (Radix) — portée dans le DS Sahla.
// Source : https://ui.shadcn.com/docs/components/radix/sidebar
// Adaptations projet : PAS de "use client" (Pages Router), `cn` depuis
// `@/utils/cn`, `useIsMobile` depuis `@/hooks/use-mobile`, primitives locales
// (Button/Input/Separator/Sheet/Skeleton/Tooltip). Largeurs alignées sur le
// token de marque (sidebar = 280px). Tokens couleur : `--sidebar*` (ds.css).
...
const SIDEBAR_WIDTH = "17.5rem"; // 280px — aligné sur --spacing-sidebar
...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Espace réservé (gap) qui pousse le contenu principal. */}
      <div
...
function SidebarMenuSkeleton({
  ...
  // Largeur du libellé (l'original shadcn varie aléatoirement ; on fixe une
  // valeur pour rester pur — règle react-hooks/purity).
  const width = "70%";
